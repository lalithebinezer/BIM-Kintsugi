...
if (!cssStr.includes('.bim-search-overlay .bim-search-modal {') && !cssStr.includes('.bim-search-modal {\n  width: 100%;')) {
  // Let's insert the modal css right before .bim-search-header
...
console.log('Fixed search modal base css');
